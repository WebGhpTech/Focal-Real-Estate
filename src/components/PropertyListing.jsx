  ...
  return (
    <div className="mx-auto rounded-lg w-full md:w-1/2 bg-white border border-gray-300 shadow-md p-4 items-center justify-center max-sm:text-center max-sm:justify-center">
          ...
          <div className="mb-6">
            ...
            <div className="p-2">
              <input
                ...
                onChange={(e) =>
                  setBedroomRange(e.target.value.split(",").map(Number))
                }
              />
          ...
          <div className="mb-6">
            ...
            <div className="p-2">
              <input
                ...
                onChange={(e) =>
                  setBathroomRange(e.target.value.split(",").map(Number))
                }
              />
              <div className="text-xs">
          ...
          <div className="mb-6">
            ...
            <div className="p-2">
              <input
                ...
                max="5"
                step="1"
                value={carportRange[0]}
                onChange={(e) =>
                  setCarportRange(e.target.value.split(",").map(Number))
                }
              />
              <div className="text-xs">
      ...
      <div className="mx-auto w-full">
        <button
          className="bg-focal-blue text-white p-2 rounded sm:w-auto max-sm:w-40"
...
const PropertyListing = ({ pg, page, type, status, limit }) => {
  ...
  const fetchData = async () => {
    try {
      let apiUrl =
        "https://focalrealestate.com.au/internal_api/framework/api/property-data-vaultre";
      ...
      {page === "home" ? (
        <div className="mb-6 mx-auto flex justify-center items-center animate-on-scroll">
          <button
            ...
            className={`py-3 px-4 inline-flex items-center gap-x-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-lg ${
              propertyType === "residential"
                ? "text-focal-blue"
                : "text-gray-800"
            } font-medium focus:z-10 border border-gray-200 bg-white shadow-sm hover:bg-gray-50 disabled:opacity-50`}
          >
          ...
          <button
            ...
            className={`py-3 px-4 inline-flex items-center gap-x-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-lg ${
              propertyType === "rental" ? "text-focal-blue" : "text-gray-800"
            } font-medium focus:z-10 border border-gray-200 bg-white shadow-sm hover:bg-gray-50 disabled:opacity-50`}
          >
        ...
        <div className="mb-8 mx-auto flex-row justify-center items-center max-sm:flex-col text-center">
          <p className="inline text-md font-semibold mr-4 max-sm:mb-2">
            Filters:{" "}
          </p>
          <button
            type="button"
              ...
              >
                ...
                <div className="p-4 md:p-5 h-44">
                  ...
                  <button className="mt-3 py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-regular rounded-lg border border-transparent bg-blue-600 text-white">
                    {/* {property.status} */}
                    {slug.pathname === "/" && property?.status === "management"
                      ? "Rental"
                      : property?.status}
                  </button>
                </div>
                <div className="bg-white inline border-t rounded-b-xl py-3 px-4 md:py-4 md:px-5">
                  ...
                  <p className="mr-2 mt-1 text-sm text-gray-500 inline">
                    {" "}
                    {property.bedrooms}{" "}
                  </p>
