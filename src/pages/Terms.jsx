          ...
          <div className="relative isolate">
            <div className="items-center justify-center py-20 p-20">
              <p className="text-md font-light mb-8 leading-6">
                ...
                the use of focalrealestate.com.au (the "Site"). This Site is
                owned and operated by Focal Real Estate Pty Ltd. This Site is a
                Real Estate Agency website website. By using this Site, you
                indicate that you have read and understand these Terms and
                Conditions and agree to abide by them at all times.
              </p>
              <h2 className="text-xl font-semibold text-focal-blue mb-3">
                Intellectual Property
              </h2>
              <p className="text-md font-light mb-8 leading-6">
                All content published and made available on our Site is the
                property of Focal Real Estate and the Site's creators. This
              ...
              <p className="text-md font-light mb-8 leading-6">
                ...
                we do not own or control. We are not responsible for the
                content, policies, or practices of any third party website or
                service linked to on our Site. It is your responsibility to read
                the terms and conditions and privacy policies of these third
              ...
              <p className="text-md font-light mb-8 leading-6">
                Focal Real Estate and our directors, officers, agents,
              ...
              <p className="text-md font-light mb-8 leading-6">
                ...
                and hold harmless Focal Real Estate and our directors, officers,
              ...
              <h2 className="text-xl font-bold text-focal-blue mb-3">
                Focal Real Estate
              </h2>
              <p className="text-md font-light mb-8 leading-6">
