      ...
      <div className="mx-auto max-w-7xl px-6 sm:py-20 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0 max-sm:mt-20">
          <div className="mx-auto max-w-xl">
            <h1 className="mx-auto mb-6 text-5xl text-gray-900 font-bold max-sm:text-center">
            ...
            <h1 className="mx-auto mb-6 text-3xl text-gray-900 font-bold max-sm:text-center">Selling has never been easier</h1>
            <p className="mb-4 text-md leading-8 text-gray-600 max-sm:text-center">
