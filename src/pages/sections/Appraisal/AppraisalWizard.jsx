...
const AppraisalWizard = () => {
  ...
  const steps = [
    ...
    "Schedule a visit",
    "Receive your property appraisal",
  ];
      ...
      <div className="mx-auto py-20 w-full items-center justify-center">
        <div className="flex mb-20 items-center justify-center max-sm:flex-col max-sm:mb-5">
          {steps.map((title, index) => (
            <div
              key={index + 1}
              className="flex items-center justify-center ml-10 max-sm:m-0"
            >
              <div
                className={`flex-shrink-0 flex rounded-full w-12 h-12  font-bold items-center justify-center text-2xl ${
                  index + 1 === step
                    ? "bg-focal-blue text-white"
                    : "bg-white text-focal-blue"
                }`}
              >
                {index + 1}
              </div>
        ...
        <div className="mx-auto max-w-3xl mb-20 items-center justify-center max-sm:p-5">
            ...
            <div>
              <div className="mx-auto mb-10 items-center justify-center">
                <h2 className="text-gray-700 text-center">
                  We collect some initial property details including land size,
                  bedrooms, bathrooms, suburb, etc. to create a solid foundation
                  for your appraisal.
                </h2>
              </div>
          ...
          {step === 2 && (
            <div>
              <div className="mx-auto mb-10 items-center justify-center">
                <h2 className="text-gray-700 text-center">
                  Walk us through your property in a physical or virtual (skype)
                  inspection. Book in on whatever day works best for you.
                </h2>
              </div>
              <div className="mx-auto max-w-xl items-center justify-center mb-6">
                <label
          ...
          {step === 3 && (
            <div>
              <div className="mx-auto max-w-2xl items-center justify-center">
                <img
                  src="./icons/check-icon-large.png"
                  className="mx-auto w-14 h-14"
                />
                <h2 className="mx-auto text-focal-blue text-xl font-bold text-center mt-3">
                  Visit Scheduled!
                </h2>
                <h3 className="text-lg font-semibold text-center mt-3 text-gray-700">
                  We'll be in touch shortly with your current market value and
                  property report.
                </h3>
                <p className="text-md text-gray-700 text-center mt-2">
                  If you'd like to ensure your report is accurate, please book a
                  call on <b>(07) 3208 6222</b> discuss the key features of your
                  property and any recent updates.
                </p>
                ...
                <p className="text-md text-gray-700 text-center mt-5">
                  After our visit. We'll provide you with a comprehensive
                  property appraisal, as well as any advice we may have for you.
                  You can also contact us with any questions you may have about
          ...
          <div className="mx-auto mt-4 max-w-xl items-center justify-center">
            ...
            {step < 3 && (
              <button
                onClick={prevStep}
                className="bg-gray-300 mt-3 rounded w-full py-2 px-4"
              >
                Back
              </button>
            )}
