      ...
      <div className="content">
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-55">
          <div className="mt-20 md:mt-10 py-10 text-center">
            ...
            <p className="mt-3 md:mt-6 text-2xl leading-8 sm:text-md  text-white ease-in-text">Find out how much your home is worth today</p>
            <div className="mt-4 md:mt-10 flex items-center justify-center">
