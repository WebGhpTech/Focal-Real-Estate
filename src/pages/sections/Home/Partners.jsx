      ...
      <div className="mx-auto max-w-7xl px-6 sm:py-20 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0 max-sm:mt-20">
          <div className="max-w-xl">
            <span className="mb-6 inline-flex items-center rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10">Our Partners</span>
            <h1 className="mb-6 text-5xl text-gray-600 font-bold">Trusted by top companies in this industry</h1>
            <p className="text-lg leading-8 text-gray-600">We've Partnered with some pretty amazing businesses</p>
          </div>
