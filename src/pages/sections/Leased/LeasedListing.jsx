...
const FilterBox = ({ onClose }) => {
  ...
  return (
    <div className="items-center justify-center w-1/2 p-4 mx-auto bg-white border border-gray-300 rounded-lg shadow-md max-sm:text-center max-sm:justify-center">
