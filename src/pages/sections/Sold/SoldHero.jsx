...
const SoldHero = () => {
  const [pageInformation, setPageInformation] = useState();
    ...
    const page_slug = "sold-properties";
  ...
  return (
    <>
    <Helmet>
      <title>Sold Properties-Focal Real Estate</title>
    ...
    <div className="relative isolate overflow-hidden">
      <img src="./1.png" alt="" className="absolute inset-0 -z-10 h-full w-full object-cover" />
